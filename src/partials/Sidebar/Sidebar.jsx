    ...
    <div>
      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          {/* Logo */}
          <NavLink end to="/" className="block text-slate-200 hover:text-white truncate transition duration-150">
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              {/* Messages */}
              <li className={`px-3 py-2 rounded-xl mb-0.5 hover:bg-slate-900 last:mb-0 ${pathname.includes('messages') && 'bg-slate-900'}`}>
                <NavLink
                  end
                  to="/"
              ...
              {/* Inbox */}
              <li className={`px-3 py-2 rounded-xl mb-0.5 hover:bg-slate-900 last:mb-0 ${pathname.includes('inbox') && 'bg-slate-900'}`}>
                <NavLink
                  end
                  to="/"
              ...
              {/* Calendar */}
              <li className={`px-3 py-2 rounded-xl mb-0.5 hover:bg-slate-900 last:mb-0 ${pathname.includes('calendar') && 'bg-slate-900'}`}>
                <NavLink
                  end
                  to="/"
              ...
              {/* Campaigns */}
              <li className={`px-3 py-2 rounded-xl mb-0.5 hover:bg-slate-900 last:mb-0 ${pathname.includes('campaigns') && 'bg-slate-900'}`}>
                <NavLink
                  end
                  to="/"
